...
let inventory = [
    ...
    { id: 2, name: "Keyboard", quantity: 25, price: 50 },
];
...
app.put('/api/items/:id', (req, res) => {
    ...
    if(item){
        ...
        res.json({ message: 'Item updated', inventory });
    } else {
...
app.delete('/api/items/:id', (req, res) => {
    ...
    res.json({ message: 'Item deleted', inventory });
});
...
// Save this below as index.html in the same folder
/*
<!DOCTYPE html>
<html>
<head>
    ...
    <script>
        ...
        async function updateItem(id, quantity, price) {
            await fetch(`/api/items/${id}`, {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ quantity: quantity ? parseInt(quantity) : undefined, price: price ? parseFloat(price) : undefined })
            });
            fetchInventory();
        }
